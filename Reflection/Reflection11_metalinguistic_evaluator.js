...
//Reflection 11: logical operators
...
function make_conditional_expression(pred, cons, alt) {
    return list("logical_composition", pred, cons, alt);
}
// helper to make a logical composition expression
function make_logical(value) {
...
function partial_accumulations_2(f, init, stream) {
    const p_accumulates = stream_combine(f, stream, pair(init, () => p_accumulates));
    return p_accumulates;
} 

eval_stream(partial_accumulations_2(func, 0, ints), 10;*/